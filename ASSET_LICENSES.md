...
All PNGs in `assets/planeshift/textures` are generated by `tools/TextureGen.java` as temporary
greybox art: a flat fill, a border, and the entry initials in a pixel font. They contain no
artwork and may be freely replaced with final production assets. No copyright is claimed on them.
