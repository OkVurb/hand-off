...
public record CourseDefinition(
    ...
    public CourseDefinition(Identifier dimension, BlockPos startPos, PlaneMode startMode, CourseTheme theme, double killY) {
        this(dimension, startPos, startMode, theme, killY, Optional.empty());
    }
