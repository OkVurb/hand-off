...
import com.studio.planeshift.common.entity.BoneCheepEntity;
...
public final class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ChainChompEntity>> CHAIN_CHOMP =
            ENTITY_TYPES.register("chain_chomp", () -> EntityType.Builder
                    .of(ChainChompEntity::new, MobCategory.MONSTER)
                    .sized(EnemyRigProfile.CHAIN_CHOMP.scaled(0.9F),
                            EnemyRigProfile.CHAIN_CHOMP.scaled(0.9F))
                    .clientTrackingRange(10)
                    .build(key("chain_chomp")));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CheepCheepEntity>> CHEEP_CHEEP =
            ENTITY_TYPES.register("cheep_cheep", () -> EntityType.Builder
                    .of(CheepCheepEntity::new, MobCategory.WATER_AMBIENT)
                    .sized(EnemyRigProfile.CHEEP_CHEEP.scaled(0.6F),
                            EnemyRigProfile.CHEEP_CHEEP.scaled(0.4F))
                    .clientTrackingRange(8)
                    .build(key("cheep_cheep")));

    public static final DeferredHolder<EntityType<?>, EntityType<BoneCheepEntity>> BONE_CHEEP =
            ENTITY_TYPES.register("bone_cheep", () -> EntityType.Builder
                    .of(BoneCheepEntity::new, MobCategory.WATER_AMBIENT)
                    .sized(EnemyRigProfile.CHEEP_CHEEP.scaled(0.6F),
                            EnemyRigProfile.CHEEP_CHEEP.scaled(0.4F))
                    .clientTrackingRange(8)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<VolcanicBombEntity>> VOLCANIC_BOMB =
            ENTITY_TYPES.register("volcanic_bomb", () -> EntityType.Builder
                    .<VolcanicBombEntity>of(VolcanicBombEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F)
                    .clientTrackingRange(10)
                    .updateInterval(1)
                    .build(key("volcanic_bomb")));
